...
namespace MultiShop.Catalog.Controllers
{
    ...
    public class FeatureSlidersController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateFeatureSlider(CreateFeatureSliderDto createFeatureSliderDto)
        {
            ...
            return Ok("Önde çıkan görsel başarıyla eklendi.");
        }
        ...
        public async Task<IActionResult> DeleteFeatureSlider(string id)
        {
            ...
            return Ok("Önde çıkan görsel başarıyla silindi.");
        }
        ...
        public async Task<IActionResult> UpdateFeatureSlider(UpdateFeatureSliderDto updateFeatureSliderDto)
        {
            ...
            return Ok("Önde çıkan görsel başarı ile güncellendi.");
        }
        ...
        //    return Ok("Önde çıkan görsel durumu başarı ile pasif yapıldı.");
        //}
        ...
        //    return Ok("Önde çıkan görsel durumu başarı ile aktif yapıldı.");
        //}
    }
}
